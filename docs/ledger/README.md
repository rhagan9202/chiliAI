...
- `docs/architecture.md` — *Why* and high-level system shape (C4 diagrams, guiding principles). This ledger documents the exact *what*.
- `docs/wiki/` — Developer wiki (module pages, contracts, flows). The ledger is the master index; the wiki has richer narrative per topic.
