...
| SAFE-CMS-002 | Durable score-all workflows | SAFE-CMS-SURGE | P1 (PI 1 Sprint 2) | planned — PI 1 spec drafted 2026-08-02 | 1 sprint |
| SAFE-CMS-003 | Production risk read models | SAFE-CMS-SURGE | P1 (PI 1 Sprint 3) | planned — PI 1 spec drafted 2026-08-02 | 1 sprint |
...
| SAFE-CMS-002 | PI 1 / Sprint 2 | Durable, replayable, observable score-all workflow. | SAFE-CMS-001 feature/version metadata. | Ready for Sprint 2 planning via PI 1 spec. |
| SAFE-CMS-003 | PI 1 / Sprint 3 | Queryable risk read models for alerts, dashboards, entities, and cohorts. | SAFE-CMS-001, SAFE-CMS-002. | Ready for Sprint 3 planning via PI 1 spec. |
