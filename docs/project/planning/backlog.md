...
| SAFE-CMS-011 | Cohort and peer analytics API | SAFE-CMS-SURGE | P1 (PI 3 Sprint 11) | in-progress — peer-analysis API, domain-pack cohort definitions, cohort membership, and distribution summaries implemented 2026-08-03 | 1 sprint |
...
| SAFE-CMS-011 | PI 3 / Sprint 11 | Cohort and peer analytics APIs. | SAFE-CMS-003, SAFE-CMS-006. | Plan drafted; peer-analysis domain/API, domain-pack cohort definitions, cohort membership, and distribution summaries implemented 2026-08-03. |
