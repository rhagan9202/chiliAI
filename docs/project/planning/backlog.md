...
| SAFE-CMS-014 | User-authored workflow builder | SAFE-CMS-SURGE | P1 (PI 4 Sprint 14) | done — workflow definition design, typed models, lifecycle service, KB-scoped API, idempotent run handoff, Postgres persistence, generated contracts, and verification landed 2026-08-04 (`d1c2aa6`..`6216c2e`) | 0 SP |
| SAFE-CMS-015 | Capability registry and governed agent tools | SAFE-CMS-SURGE | P1 (PI 4 Sprint 15) | done — typed capability registry, KB-scoped browse API, workflow validation, permission checks, execution envelopes, registry browser, RAG/connector adapters, and verification landed 2026-08-05 (`e3fd63b`..`4df497f`) | 0 SP |
...
| SAFE-CMS-014 | PI 4 / Sprint 14 | Permissioned user-authored workflow builder. | SAFE-CMS-002, SAFE-CMS-004, SAFE-CMS-013. | Implemented 2026-08-04: workflow ADR/design, models, lifecycle service, API, run idempotency, Postgres persistence, and generated contracts. |
| SAFE-CMS-015 | PI 4 / Sprint 15 | Governed capability registry and agent tool permissions. | SAFE-CMS-013, SAFE-CMS-014. | Implemented 2026-08-05: capability registry/API, workflow validation, permission checks, execution envelopes, browser UI, and RAG/connector adapters. |
