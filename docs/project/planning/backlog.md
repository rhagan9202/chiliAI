...
| SAFE-CMS-017 | PI 5 / Sprint 17 | Pull connectors for CMS-adjacent data sources. | SAFE-CMS-004, SAFE-CMS-013. | Implemented 2026-08-05: connector domain/API, sync and quarantine tracking, local filesystem adapter, frontend management, and status capability adapter. |
