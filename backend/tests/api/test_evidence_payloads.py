...
from api.dependencies import _evidence_pack_to_response, build_evidence_provenance_response
...
def test_evidence_provenance_response_lists_pack_refs() -> None:
    ...
    payload = build_evidence_provenance_response(
