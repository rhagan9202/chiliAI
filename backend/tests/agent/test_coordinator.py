...
def test_graceful_shutdown_finishes_in_flight_event(
    ...
    fake_deps = WorkerDependencies(
        ...
        records_analytics_throttle=MetricsRecomputeThrottle(min_interval_seconds=300),
        risk_history_writer=InMemoryRiskHistoryWriter(),
        alert_history_writer=InMemoryAlertHistoryWriter(),
...
def test_dispatch_runs_kb_cleanup_when_wired_and_guards_when_not() -> None:
    ...
    store_fields = [
        ...
        "risk_history_writer", "risk_projection_repository", "observation_writer", "alert_history_writer",
    ...
    mocks["risk_projection_repository"].delete_by_kb.assert_called_once_with("kb-x")
