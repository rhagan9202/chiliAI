...
test.describe('Knowledge Bases document warnings', () => {
  test('shows a warning chip with reasons after ingesting a ragged CSV', async ({ page }) => {
    ...
    // Guarantees cleanup even if an assertion below throws — this is the
    // exact spec whose earlier race left a "warn-e2e-…" knowledge base
    // stranded until global teardown reclaimed it.
